...
namespace UserService.Controllers
{
    ...
    public class UsersVersionedController : ControllerBase
    {
        private readonly IUserRepository _usersRepository;
        private readonly UsersServiceContext _context;
        private readonly AppSettings _appSettings;
        public UsersVersionedController(IUserRepository usersRepository, UsersServiceContext context, IOptions<AppSettings> appSettings)
        {
